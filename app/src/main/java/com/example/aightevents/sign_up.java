...
public class sign_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sta.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                emailTextSU = findViewById(R.id.emailOrg);
    ...
    public int checkForInput(String emailSU, String passwordSU, String confPasswordSU){
        ...
        if(passwordSU.isEmpty()){
            ...
            passwordTextSU.setBackground(getDrawable(R.drawable.blue_round_border));
        ...
        if(emailSU.isEmpty()){
            ...
            emailTextSU.setBackground(getDrawable(R.drawable.blue_round_border));
        ...
        if(confPasswordSU.isEmpty()){
            ...
            confPasswordTextSU.setBackground(getDrawable(R.drawable.blue_round_border));
    ...
    public void updateUI (GoogleSignInAccount gsia){
        if(gsia == null){
            ...
            startActivity(new Intent(sign_up.this, participant_page.class));
            finish();
        }
    }
